...
namespace Velt::Renderer::Vulkan
{
	...
	void VulkanDevice::pickPhysicalDevice()
	{
		...
		{
			VT_CORE_ASSERT(false, "Physical device does not support Vulkan 1.3!");
		}
		VT_CORE_INFO("Vulkan API Version: {}.{}. {}",
	...
	void VulkanDevice::createLogicalDevice()
	{
		...
		// Vulkan 1.2 features (optional but recommended)
	...
	bool VulkanDevice::isDeviceSuitable(VkPhysicalDevice device)
	{
		...
		{
			VT_CORE_WARN("Device {} does not support Vulkan 1.3", deviceProperties.deviceName);
			return false;
		}
		...
		{
			VT_CORE_WARN("Device {} does not support dynamic rendering", deviceProperties.deviceName);
			return false;
		}
		...
		VkDeviceMemory& bufferMemory)
	{
		...
		{
			VT_CORE_ASSERT(false, "Failed to create Device Buffer!");
		}
